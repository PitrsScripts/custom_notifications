...
/testnotify
```
This command will show all notification types (success, error, warning, info) with different durations to test the notification system. Each notification appears with a 1-second delay between them.
